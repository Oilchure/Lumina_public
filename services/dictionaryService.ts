import { DICTIONARY_API_URL, API_TIMEOUT_MS, MAX_DEFINITIONS_TO_SAVE, API_POS_TO_CHINESE_MAP } from '../constants';
import { WordDefinition, DictionaryAPIResponse, PartOfSpeechCh } from '../types';
