...
import OutlineManagementPage from './pages/OutlineManagementPage';
import MindMapPage from './pages/MindMapPage'; // Added MindMapPage
      ...
      <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-900">
        ...
        <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8">
          <Routes>
            ...
            <Route path="/mindmap" element={<MindMapPage />} /> {/* Added MindMapPage Route */}
